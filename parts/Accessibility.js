      ...
      <div className={`centeredContent ${styles.accessibilityInner}`}>
        ...
        <div className={styles.accessibilityContent}>
          <div className={styles.item}>
            ...
            <p>
              La ciudad principal del lago Panguipulli donde podrás acceder a
          ...
          <div className={styles.item}>
            ...
            <p>
              Disfruta de diversas disciplinas culturales y artísticas en un
              lugar cercano desde el proyecto.
            </p>
          </div>
          <div className={styles.item}>
            <img src="./images/iconBeachAlt.svg" alt="ícono playa 2" />
            <h4>A 5 min de playa Panguipulli y 10 km de playa Coz Coz</h4>
            <p>
              Diversas y muy hermosas playas de agua cristalina para visitar y
              disfrutar.
            </p>
          </div>
        </div>
